...
ARTICLE_PATH_CANDIDATES = [
    os.path.join(SCRIPT_DIR, "market_articles_with_content_labeled.csv"),
    os.path.join(SCRIPT_DIR, "market_only_articles_with_content_labeled.csv"),
    os.path.join(SCRIPT_DIR, "nbc_news_labeled.csv"),
    os.path.join(SCRIPT_DIR, "..", "data", "BERT", "market_articles_with_content_labeled.csv"),
]
ARTICLES_RAW = resolve_first_existing(ARTICLE_PATH_CANDIDATES, description="market article dataset CSV")
...
PRED_COMBINED_CSV = os.path.join(OUTPUT_DIR, "market_article_predictions.csv")
MODEL_PATH = os.path.join(OUTPUT_DIR, "market_article_direction_model.pt")
MODEL_KERAS_PATH = os.path.join(OUTPUT_DIR, "market_article_price_classifier_model.keras")
SHAPLEY_DATA_PATH = os.path.join(OUTPUT_DIR, "market_article_shapley_data.npz")
