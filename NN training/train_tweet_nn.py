#!/usr/bin/env python3
"""Standardized training pipeline for tweet neural network classification.

This script reproduces the workflow from `nn-pipeline.ipynb`
...
MODEL_SAVE_PATH = os.path.join(OUTPUT_DIR, "tweet_price_classifier_model.keras")
PREDICTIONS_CSV = os.path.join(OUTPUT_DIR, "tweet_predictions.csv")
...
def main() -> None:
    ...
    print("=" * 80)
    print("TWEET PRICE DIRECTION CLASSIFIER")
