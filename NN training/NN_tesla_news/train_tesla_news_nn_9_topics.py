...
DATA_PATH_CANDIDATES = [
    "data/daily_tesla_topic_sentiment_price_9.csv",
...
MODEL_SAVE_PATH = os.path.join(OUTPUT_DIR, "tesla_news_price_classifier_model_9.keras")
PREDICTIONS_CSV = os.path.join(OUTPUT_DIR, "tesla_news_predictions_9.csv")
...
def main() -> None:
    ...
    shapley_data_path = os.path.join(OUTPUT_DIR, "tesla_news_shapley_data_9.npz")
