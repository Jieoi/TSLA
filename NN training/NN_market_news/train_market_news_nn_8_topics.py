...
DATA_PATH_CANDIDATES = [
    "data/daily_market_topic_sentiment_price_8.csv",
]
...
MODEL_SAVE_PATH = os.path.join(OUTPUT_DIR, "market_news_price_classifier_model_8.keras")
PREDICTIONS_CSV = os.path.join(OUTPUT_DIR, "market_news_predictions_8.csv")
...
def main() -> None:
    ...
    shapley_data_path = os.path.join(OUTPUT_DIR, "market_news_shapley_data_8.npz")
