...
DATA_PATH_CANDIDATES = [
    "data/daily_market_topic_sentiment_price_9.csv",
]
...
MODEL_SAVE_PATH = os.path.join(OUTPUT_DIR, "market_news_price_classifier_model_9.keras")
PREDICTIONS_CSV = os.path.join(OUTPUT_DIR, "market_news_predictions_9.csv")
...
def main() -> None:
    ...
    shapley_data_path = os.path.join(OUTPUT_DIR, "market_news_shapley_data_9.npz")
