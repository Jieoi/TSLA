...
DATA_PATH_CANDIDATES = [
    "daily_tesla_topic_sentiment_price.csv",
    os.path.join("..", "data", "process_data", "news", "daily_tesla_topic_sentiment_price.csv"),
]
OUTPUT_DIR = "outputs"
...
MODEL_SAVE_PATH = os.path.join(OUTPUT_DIR, "tesla_news_price_classifier_model.keras")
PREDICTIONS_CSV = os.path.join(OUTPUT_DIR, "tesla_news_predictions.csv")
...
def main() -> None:
    ...
    shapley_data_path = os.path.join(OUTPUT_DIR, "tesla_news_shapley_data.npz")
